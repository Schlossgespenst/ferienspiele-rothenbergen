const config = {
  ...
  registrationStart: new Date('2022-05-01'),
  registrationDeadline: new Date('2022-06-27'),
  waiverDeadline: new Date('2021-07-26'),
  maxParticipants: 50,
  prices: {
    base: 35,
    sibling: -10,
  ...
  shirtSizes: [
    ...
    { value: 'CHILDREN_5-6y', label: 'Kinder 5-6 Jahre' },
    { value: 'CHILDREN_7-8y', label: 'Kinder 7-8 Jahre' },
    { value: 'CHILDREN_9-11y', label: 'Kinder 9-11 Jahre' },
    { value: 'CHILDREN_12-14y', label: 'Kinder 12-14 Jahre' },
  ],
};
